...
import logoLightPng from "assets/images/etsLogo.png";

const Login = props => {

  //meta title
  document.title = "Login | EDAS - ETS";
                  ...
                  <Row>
                    <Col className="col-7">
                      <div className="text-primary p-4">
                        ...
                        <p>Sign in to continue to EDAS.</p>
                      </div>
                    </Col>
                    <Col className="col-5 align-self-end" style={{padding:20}}>
